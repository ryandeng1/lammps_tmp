...
class Force : protected Pointers {
 public:
  ...
  typedef Bond *(*BondCreatorStencilMD)(LAMMPS *, Modify *);
  typedef std::map<std::string, BondCreatorStencilMD> BondCreatorMapStencilMD;
  BondCreatorMapStencilMD *bond_map_stencil_md;
  ...
  void create_bond(const std::string &, int, bool use_stencil_md = false, Modify* = nullptr);
  Bond *new_bond(const std::string &, int, int &, bool use_stencil_md = false, Modify* = nullptr);
