...
void CommBrick::receive_data_process_stencil_md(MPI_Request* request, int recv_zoid_num, bool is_initial) {
...
void CommBrick::unpack_data_process_stencil_md(int recv_zoid_num, bool is_initial) {
